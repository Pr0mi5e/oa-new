...
#工程绝对路径
project_path=D:/ProjectCode/OA/Mobile/trunk
...
C:/android-sdk-windows/build-tools/25.0.2/zipalign -v 4 ${exportApkPath}/apk/android-release-unsigned.apk ${exportApkPath}/apk/oa_debug.apk
