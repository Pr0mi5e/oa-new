...
project_path=/Users/zwmac/Documents/Hybrid-workspace/Mobile-OA-IOS-Ly

cd ${project_path}

cp -r ${project_path}/resources_default/ios ${project_path}/resources
cp -r ${project_path}/resources_default/icon.png ${project_path}/resources
...
#导出.ipa文件所在路径
exportIpaPath=${project_path}/Build_scripts/IPADir/${development_mode}
...
#development_mode=Release
#plist文件所在路径
exportOptionsPlistPath=${project_path}/Build_scripts/ExportOptions_dev.plist
#else
#development_mode=Release
#exportOptionsPlistPath=${project_path}/exportTest.plist
#fi
