...
(function() {
  ...
  var app = angular.module('community.controllers.chats');

  app.controller('ChatsController', ['$scope', 'Chats',
    ...
    // app.controller('ChatDetailController', ['$scope', '$stateParams', 'Chats',
