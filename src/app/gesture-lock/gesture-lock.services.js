...
(function () {
    ...
    var app = angular.module('community.services.gestureLock', []);

    app.factory('gestureLockService', [function () {
        return {
    ...
    app.factory("$gestureLock", [function () {
        /***
         * 画密码圆环
        ...
        GestureLock.prototype.destructor = function () {
            document.body.removeEventListener('touchmove', bodyScroll, false);
        };
        return GestureLock;
    }]);

    app.service('GestureLockService', ['$q', '$http', '$ionicLoading', '$timeout', 'T', '$cordovaToast', 'timeout', '$httpParamSerializer',
        function ($q, $http, $ionicLoading, $timeout, T, $cordovaToast, timeout, $httpParamSerializer) {
            var setGestureLock = function (url, param) {
                $ionicLoading.show({
                    content: 'Loading',
                    animation: 'fade-in',
                    showBackdrop: true,
...
//                headers : {'Content-Type': 'application/json'}
            ...
            var changeGestureLock = function (url, param) {
                $ionicLoading.show({
                    content: 'Loading',
                    animation: 'fade-in',
                    showBackdrop: true,
...
//                headers : {'Content-Type': 'application/json'}
            ...
            return {
                ...
                changeGestureLock: changeGestureLock
            }
        }]);
})();
